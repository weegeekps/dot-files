...
return {
    {
        ...
        keys = {
            { "<Leader>1", ":Neotree toggle<CR>", desc = "Open Tree", silent = true },
            {
                "<Leader>2",
                ":Neotree source=filesystem reveal=true<CR>",
                desc = "Focus Tree on Filesystem",
                silent = true,
            },
            { "<Leader>3", ":Neotree source=buffers reveal=true<CR>", desc = "Focus Tree on Buffers", silent = true },
            { "<Leader>4", ":Neotree source=git_status reveal=true<CR>", desc = "Focus Tree on Git", silent = true },
        },
        config = function()
            ...
            require("neo-tree").setup({
                ...
                -- Ensure we don't open files in incorrect windows.
